...
| 7 | **Planificaciones** y **Torneos** | Pestañas Próximos/Pasados, sin duplicar el destacado, señal de notas. Después: Física y Patín como dos clases hermanas. | ✅ | `935d71f` · `e263812` · `3712573` · `84ffc12` · `30cfb37` · `dc4e272` · `8dccd3c` · `95ff423` (main) · `c57ad2a` |
