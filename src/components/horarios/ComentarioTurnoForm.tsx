...
import { agregarComentarioTurno, type FormState } from "@/app/(dashboard)/horarios/actions";
import { Spinner } from "@/components/ui/spinner";

const initialState: FormState = { error: null };

export function ComentarioTurnoForm({ turnoId }: { turnoId: string }) {
  const agregarComentarioConId = agregarComentarioTurno.bind(null, turnoId);
